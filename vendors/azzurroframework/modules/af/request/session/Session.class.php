...
*/
	...
	class Session {
		...
		public function __construct($config) {
			...
			// Save cookies variable references
			global $_COOKIE;
			...
			if (session_status() != PHP_SESSION_ACTIVE) {
				...
				// There is a cookie session id, let's check if it is a valid session
					...
					if (array_search('sess_' . $id, $sessions)) {
						...
						if (isset($this->_SESSION['destroyed'])) {
							// Check if the session has gone into timeout
							if ($this->_SESSION['destroyed'] < time() - $this->config['timeout']) {
							...
							} else if ($this->_SESSION['session_id']) {
						...
						} else if ($this->_SESSION['generation_time'] < time() - $this->config['expiration']) {
						...
						} else if ($this->_SESSION['generation_time'] < time() - $this->config['lifespan']) {
		...
		public function regenerate() {
			...
			if (!$this->generated) {
				...
				$this->_SESSION['session_id'] = $id;
				// Set destroy timestamp
				$this->_SESSION['destroyed'] = time();
				...
				$this->_SESSION['generation_time'] = time();
			}
